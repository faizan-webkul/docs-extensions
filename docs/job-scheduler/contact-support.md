...
That wraps up the user guide for the **UnoPim Job Scheduler** extension. We hope this documentation helps you set up and use the scheduler in UnoPim with confidence.
...
- report an issue,
- ask a setup or scheduling question,
